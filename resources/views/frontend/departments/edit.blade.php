                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.departments.update", [$department->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dept_code" id="dept_code" value="{{ old('dept_code', $department->dept_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hex_color" id="hex_color" value="{{ old('hex_color', $department->hex_color) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="dept_intro" id="dept_intro">{!! old('dept_intro', $department->dept_intro) !!}</textarea>
