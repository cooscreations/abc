    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.component-part-names.update", [$componentPartName->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.componentPartName.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $componentPartName->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_name" id="short_name" value="{{ old('short_name', $componentPartName->short_name) }}">
...
Dropzone.options.photoDropzone = {
    url: '{{ route('frontend.component-part-names.storeMedia') }}',
    maxFilesize: 2, // MB
