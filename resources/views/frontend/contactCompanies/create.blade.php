                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contact-companies.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_short_code" id="company_short_code" value="{{ old('company_short_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="formal_reg_name" id="formal_reg_name" value="{{ old('formal_reg_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="company_reg_date" id="company_reg_date" value="{{ old('company_reg_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_reg_num" id="company_reg_num" value="{{ old('company_reg_num', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="company_reg_expiry" id="company_reg_expiry" value="{{ old('company_reg_expiry') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="export_license_num" id="export_license_num" value="{{ old('export_license_num', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="import_license_num" id="import_license_num" value="{{ old('import_license_num', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="social_9001" id="social_9001" value="1" {{ old('social_9001', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="production_9001" id="production_9001" value="1" {{ old('production_9001', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="anti_slavery_policy" id="anti_slavery_policy" value="1" {{ old('anti_slavery_policy', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="bsci_certified" id="bsci_certified" value="1" {{ old('bsci_certified', 0) == 1 ? 'checked' : '' }}>
