                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contact-companies.update", [$contactCompany->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_short_code" id="company_short_code" value="{{ old('company_short_code', $contactCompany->company_short_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="parent_company_id" id="parent_company_id">
                                @foreach($parent_companies as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('parent_company_id') ? old('parent_company_id') : $contactCompany->parent_company->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_company_type_id" id="primary_company_type_id" required>
                                @foreach($primary_company_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('primary_company_type_id') ? old('primary_company_type_id') : $contactCompany->primary_company_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="reg_country_id" id="reg_country_id" required>
                                @foreach($reg_countries as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('reg_country_id') ? old('reg_country_id') : $contactCompany->reg_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="formal_reg_name" id="formal_reg_name" value="{{ old('formal_reg_name', $contactCompany->formal_reg_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="local_name" id="local_name" value="{{ old('local_name', $contactCompany->local_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="company_reg_date" id="company_reg_date" value="{{ old('company_reg_date', $contactCompany->company_reg_date) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_english_speaking_staff" id="has_english_speaking_staff" value="1" {{ $contactCompany->has_english_speaking_staff || old('has_english_speaking_staff', 0) === 1 ? 'checked' : '' }}>
                                <label for="has_english_speaking_staff">{{ trans('cruds.contactCompany.fields.has_english_speaking_staff') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="owner_contact_id" id="owner_contact_id">
                                @foreach($owner_contacts as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('owner_contact_id') ? old('owner_contact_id') : $contactCompany->owner_contact->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ownership_type_id" id="ownership_type_id">
                                @foreach($ownership_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('ownership_type_id') ? old('ownership_type_id') : $contactCompany->ownership_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_reg_num" id="company_reg_num" value="{{ old('company_reg_num', $contactCompany->company_reg_num) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="company_reg_expiry" id="company_reg_expiry" value="{{ old('company_reg_expiry', $contactCompany->company_reg_expiry) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="export_license_num" id="export_license_num" value="{{ old('export_license_num', $contactCompany->export_license_num) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="import_license_num" id="import_license_num" value="{{ old('import_license_num', $contactCompany->import_license_num) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="social_9001" id="social_9001" value="1" {{ $contactCompany->social_9001 || old('social_9001', 0) === 1 ? 'checked' : '' }}>
                                <label for="social_9001">{{ trans('cruds.contactCompany.fields.social_9001') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="production_9001" id="production_9001" value="1" {{ $contactCompany->production_9001 || old('production_9001', 0) === 1 ? 'checked' : '' }}>
                                <label for="production_9001">{{ trans('cruds.contactCompany.fields.production_9001') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="anti_slavery_policy" id="anti_slavery_policy" value="1" {{ $contactCompany->anti_slavery_policy || old('anti_slavery_policy', 0) === 1 ? 'checked' : '' }}>
                                <label for="anti_slavery_policy">{{ trans('cruds.contactCompany.fields.anti_slavery_policy') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="bsci_certified" id="bsci_certified" value="1" {{ $contactCompany->bsci_certified || old('bsci_certified', 0) === 1 ? 'checked' : '' }}>
                                <label for="bsci_certified">{{ trans('cruds.contactCompany.fields.bsci_certified') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_language_id" id="primary_language_id">
                                @foreach($primary_languages as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('primary_language_id') ? old('primary_language_id') : $contactCompany->primary_language->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="addresses[]" id="addresses" multiple>
                                @foreach($addresses as $id => $addresses)
                                    <option value="{{ $id }}" {{ (in_array($id, old('addresses', [])) || $contactCompany->addresses->contains($id)) ? 'selected' : '' }}>{{ $addresses }}</option>
                                @endforeach
                            </select>
