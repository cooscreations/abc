                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.languages.update", [$language->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $language->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alpha_2" id="alpha_2" value="{{ old('alpha_2', $language->alpha_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="local_name" id="local_name" value="{{ old('local_name', $language->local_name) }}">
