    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.currency-rates.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="usd_value">{{ trans('cruds.currencyRate.fields.usd_value') }}</label>
                            <input class="form-control" type="number" name="usd_value" id="usd_value" value="{{ old('usd_value', '') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="valid_until" id="valid_until" value="{{ old('valid_until') }}">
