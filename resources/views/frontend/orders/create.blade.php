                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_order_num" id="afa_order_num" value="{{ old('afa_order_num', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="cust_order_date" id="cust_order_date" value="{{ old('cust_order_date') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ukfr" id="ukfr" value="1" {{ old('ukfr', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer_order_number" id="customer_order_number" value="{{ old('customer_order_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pi_value_placed_usd" id="pi_value_placed_usd" value="{{ old('pi_value_placed_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ci_value_shipped_usd" id="ci_value_shipped_usd" value="{{ old('ci_value_shipped_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_deposit_value_usd" id="customer_deposit_value_usd" value="{{ old('customer_deposit_value_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_deposit_rate" id="customer_deposit_rate" value="{{ old('customer_deposit_rate', '20') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="cust_dep_rec_date" id="cust_dep_rec_date" value="{{ old('cust_dep_rec_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="order_sent_to_supplier_date" id="order_sent_to_supplier_date" value="{{ old('order_sent_to_supplier_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="allowance_usd" id="allowance_usd" value="{{ old('allowance_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="customer_required_ship_date" id="customer_required_ship_date" value="{{ old('customer_required_ship_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="crd_target_date" id="crd_target_date" value="{{ old('crd_target_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_date" id="booking_date" value="{{ old('booking_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="so_date" id="so_date" value="{{ old('so_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_balance_usd" id="customer_balance_usd" value="{{ old('customer_balance_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="balance_received_date" id="balance_received_date" value="{{ old('balance_received_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="po_value_placed_usd" id="po_value_placed_usd" value="{{ old('po_value_placed_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="po_value_shipped_usd" id="po_value_shipped_usd" value="{{ old('po_value_shipped_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="supplier_deposit_usd" id="supplier_deposit_usd" value="{{ old('supplier_deposit_usd', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="supplier_deposit_paid_date" id="supplier_deposit_paid_date" value="{{ old('supplier_deposit_paid_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="handling_charge_and_allowance_usd" id="handling_charge_and_allowance_usd" value="{{ old('handling_charge_and_allowance_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="documents_received_date" id="documents_received_date" value="{{ old('documents_received_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="supplier_balance_usd" id="supplier_balance_usd" value="{{ old('supplier_balance_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="supplier_balance_paid_date" id="supplier_balance_paid_date" value="{{ old('supplier_balance_paid_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="commission_usd" id="commission_usd" value="{{ old('commission_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="commission_paid_date" id="commission_paid_date" value="{{ old('commission_paid_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="req_fumigtion" id="req_fumigtion" value="{{ old('req_fumigtion', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fumigation_cost_usd" id="fumigation_cost_usd" value="{{ old('fumigation_cost_usd', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="profit_usd" id="profit_usd" value="{{ old('profit_usd', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="profit_ratio" id="profit_ratio" value="{{ old('profit_ratio', '0.00') }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fn_audit_complete_date" id="fn_audit_complete_date" value="{{ old('fn_audit_complete_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_days_to_complete" id="total_days_to_complete" value="{{ old('total_days_to_complete', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_tolerance" id="qty_tolerance" value="{{ old('qty_tolerance', '10') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="size_tolerance" id="size_tolerance" value="{{ old('size_tolerance', '20') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="leadtime_days" id="leadtime_days" value="{{ old('leadtime_days', '65 - 80') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cny_to_usd_rate_today" id="cny_to_usd_rate_today" value="{{ old('cny_to_usd_rate_today', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="price_expiry_date" id="price_expiry_date" value="{{ old('price_expiry_date') }}">
