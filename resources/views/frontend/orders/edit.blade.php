                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_order_num" id="afa_order_num" value="{{ old('afa_order_num', $order->afa_order_num) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="cust_order_date" id="cust_order_date" value="{{ old('cust_order_date', $order->cust_order_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="order_status_id" id="order_status_id" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ukfr" id="ukfr" value="1" {{ $order->ukfr || old('ukfr', 0) === 1 ? 'checked' : '' }}>
                                <label for="ukfr">{{ trans('cruds.order.fields.ukfr') }}</label>
                            </div>
                            @if($errors->has('ukfr'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ukfr') }}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer_order_number" id="customer_order_number" value="{{ old('customer_order_number', $order->customer_order_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="order_placed_by_id" id="order_placed_by_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="shipping_agent_id" id="shipping_agent_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ship_from_port_id" id="ship_from_port_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ship_to_port_id" id="ship_to_port_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ship_to_address_id" id="ship_to_address_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bill_to_address_id" id="bill_to_address_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pi_value_placed_usd" id="pi_value_placed_usd" value="{{ old('pi_value_placed_usd', $order->pi_value_placed_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ci_value_shipped_usd" id="ci_value_shipped_usd" value="{{ old('ci_value_shipped_usd', $order->ci_value_shipped_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_deposit_value_usd" id="customer_deposit_value_usd" value="{{ old('customer_deposit_value_usd', $order->customer_deposit_value_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_deposit_rate" id="customer_deposit_rate" value="{{ old('customer_deposit_rate', $order->customer_deposit_rate) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="cust_dep_rec_date" id="cust_dep_rec_date" value="{{ old('cust_dep_rec_date', $order->cust_dep_rec_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="order_sent_to_supplier_date" id="order_sent_to_supplier_date" value="{{ old('order_sent_to_supplier_date', $order->order_sent_to_supplier_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="allowance_usd" id="allowance_usd" value="{{ old('allowance_usd', $order->allowance_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="customer_required_ship_date" id="customer_required_ship_date" value="{{ old('customer_required_ship_date', $order->customer_required_ship_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="crd_target_date" id="crd_target_date" value="{{ old('crd_target_date', $order->crd_target_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="quality_control_staffs[]" id="quality_control_staffs" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="booking_date" id="booking_date" value="{{ old('booking_date', $order->booking_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="so_date" id="so_date" value="{{ old('so_date', $order->so_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="customer_balance_usd" id="customer_balance_usd" value="{{ old('customer_balance_usd', $order->customer_balance_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="balance_received_date" id="balance_received_date" value="{{ old('balance_received_date', $order->balance_received_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="po_value_placed_usd" id="po_value_placed_usd" value="{{ old('po_value_placed_usd', $order->po_value_placed_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="po_value_shipped_usd" id="po_value_shipped_usd" value="{{ old('po_value_shipped_usd', $order->po_value_shipped_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="supplier_deposit_usd" id="supplier_deposit_usd" value="{{ old('supplier_deposit_usd', $order->supplier_deposit_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="supplier_deposit_paid_date" id="supplier_deposit_paid_date" value="{{ old('supplier_deposit_paid_date', $order->supplier_deposit_paid_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="handling_charge_and_allowance_usd" id="handling_charge_and_allowance_usd" value="{{ old('handling_charge_and_allowance_usd', $order->handling_charge_and_allowance_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="documents_received_date" id="documents_received_date" value="{{ old('documents_received_date', $order->documents_received_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="supplier_balance_usd" id="supplier_balance_usd" value="{{ old('supplier_balance_usd', $order->supplier_balance_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="supplier_balance_paid_date" id="supplier_balance_paid_date" value="{{ old('supplier_balance_paid_date', $order->supplier_balance_paid_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="commission_usd" id="commission_usd" value="{{ old('commission_usd', $order->commission_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="commission_paid_date" id="commission_paid_date" value="{{ old('commission_paid_date', $order->commission_paid_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="packaging_type_id" id="packaging_type_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="req_fumigtion" id="req_fumigtion" value="{{ old('req_fumigtion', $order->req_fumigtion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fumigation_cost_usd" id="fumigation_cost_usd" value="{{ old('fumigation_cost_usd', $order->fumigation_cost_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="profit_usd" id="profit_usd" value="{{ old('profit_usd', $order->profit_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="profit_ratio" id="profit_ratio" value="{{ old('profit_ratio', $order->profit_ratio) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fn_audit_complete_date" id="fn_audit_complete_date" value="{{ old('fn_audit_complete_date', $order->fn_audit_complete_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_days_to_complete" id="total_days_to_complete" value="{{ old('total_days_to_complete', $order->total_days_to_complete) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_tolerance" id="qty_tolerance" value="{{ old('qty_tolerance', $order->qty_tolerance) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="size_tolerance" id="size_tolerance" value="{{ old('size_tolerance', $order->size_tolerance) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="leadtime_days" id="leadtime_days" value="{{ old('leadtime_days', $order->leadtime_days) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cny_to_usd_rate_today" id="cny_to_usd_rate_today" value="{{ old('cny_to_usd_rate_today', $order->cny_to_usd_rate_today) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="price_expiry_date" id="price_expiry_date" value="{{ old('price_expiry_date', $order->price_expiry_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="afa_bank_account_to_pay_id" id="afa_bank_account_to_pay_id">
