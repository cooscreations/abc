    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-code-groups.update", [$productCodeGroup->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.productCodeGroup.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $productCodeGroup->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $productCodeGroup->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="range_start" id="range_start" value="{{ old('range_start', $productCodeGroup->range_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="range_end" id="range_end" value="{{ old('range_end', $productCodeGroup->range_end) }}">
