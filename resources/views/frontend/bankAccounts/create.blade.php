    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bank-accounts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.bankAccount.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', 'Default Account') }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="beneficiary" id="beneficiary" value="{{ old('beneficiary', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tlx_number" id="tlx_number" value="{{ old('tlx_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="default_comment_on_tnx" id="default_comment_on_tnx">{{ old('default_comment_on_tnx') }}</textarea>
