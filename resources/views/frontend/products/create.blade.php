                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_model_number" id="afa_model_number" value="{{ old('afa_model_number', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_nickname_id" id="primary_nickname_id">
                                @foreach($primary_nicknames as $id => $entry)
                                    <option value="{{ $id }}" {{ old('primary_nickname_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="product_code_group_id" id="product_code_group_id">
                                @foreach($product_code_groups as $id => $entry)
                                    <option value="{{ $id }}" {{ old('product_code_group_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_function_id" id="default_function_id">
                                @foreach($default_functions as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_function_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="product_collection_id" id="product_collection_id">
                                @foreach($product_collections as $id => $entry)
                                    <option value="{{ $id }}" {{ old('product_collection_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_group_id" id="default_group_id">
                                @foreach($default_groups as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_group_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_storage_id" id="default_storage_id">
                                @foreach($default_storages as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_storage_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_gas_lift_config_id" id="default_gas_lift_config_id">
                                @foreach($default_gas_lift_configs as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_gas_lift_config_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_drawer_config_id" id="default_drawer_config_id">
                                @foreach($default_drawer_configs as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_drawer_config_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_drawer_movement_id" id="default_drawer_movement_id">
                                @foreach($default_drawer_movements as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_drawer_movement_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_tv_config_id" id="default_tv_config_id">
                                @foreach($default_tv_configs as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_tv_config_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_visitor_config_id" id="default_visitor_config_id">
                                @foreach($default_visitor_configs as $id => $entry)
                                    <option value="{{ $id }}" {{ old('default_visitor_config_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="extra_letters_used_in_skus[]" id="extra_letters_used_in_skus" multiple>
                                @foreach($extra_letters_used_in_skus as $id => $extra_letters_used_in_sku)
                                    <option value="{{ $id }}" {{ in_array($id, old('extra_letters_used_in_skus', [])) ? 'selected' : '' }}>{{ $extra_letters_used_in_sku }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_material_id" id="primary_material_id">
                                @foreach($primary_materials as $id => $entry)
                                    <option value="{{ $id }}" {{ old('primary_material_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_launched" id="date_launched" value="{{ old('date_launched') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_suppliers[]" id="primary_suppliers" multiple>
                                @foreach($primary_suppliers as $id => $primary_suppliers)
                                    <option value="{{ $id }}" {{ in_array($id, old('primary_suppliers', [])) ? 'selected' : '' }}>{{ $primary_suppliers }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="std_qty_feet" id="std_qty_feet" value="{{ old('std_qty_feet', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="std_qty_boxes" id="std_qty_boxes" value="{{ old('std_qty_boxes', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="std_packaging_id" id="std_packaging_id">
                                @foreach($std_packagings as $id => $entry)
                                    <option value="{{ $id }}" {{ old('std_packaging_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="beauty_shot-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="iso_naked-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="public_description" id="public_description">{!! old('public_description') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="other_photos-dropzone">
                            </div>
