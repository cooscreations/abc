                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_model_number" id="afa_model_number" value="{{ old('afa_model_number', $product->afa_model_number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_launched" id="date_launched" value="{{ old('date_launched', $product->date_launched) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="std_qty_feet" id="std_qty_feet" value="{{ old('std_qty_feet', $product->std_qty_feet) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="std_qty_boxes" id="std_qty_boxes" value="{{ old('std_qty_boxes', $product->std_qty_boxes) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="public_description" id="public_description">{!! old('public_description', $product->public_description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $product->internal_notes) }}">
