    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-skus.update", [$productSku->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="product_sku">{{ trans('cruds.productSku.fields.product_sku') }}</label>
                            <input class="form-control" type="text" name="product_sku" id="product_sku" value="{{ old('product_sku', $productSku->product_sku) }}">
