                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.addresses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="add_line_1" id="add_line_1" value="{{ old('add_line_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="add_line_2" id="add_line_2" value="{{ old('add_line_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="add_line_3" id="add_line_3" value="{{ old('add_line_3', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_billing_address" id="is_billing_address" value="1" {{ old('is_billing_address', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_shipping_address" id="is_shipping_address" value="1" {{ old('is_shipping_address', 0) == 1 ? 'checked' : '' }}>
