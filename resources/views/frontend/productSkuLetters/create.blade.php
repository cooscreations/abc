    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-sku-letters.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="letter_code">{{ trans('cruds.productSkuLetter.fields.letter_code') }}</label>
                            <input class="form-control" type="text" name="letter_code" id="letter_code" value="{{ old('letter_code', '') }}" required>
