    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.component-parts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_fabric_finish_choice" id="has_fabric_finish_choice" value="1" {{ old('has_fabric_finish_choice', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_sub_assembly" id="is_sub_assembly" value="1" {{ old('is_sub_assembly', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="length_mm" id="length_mm" value="{{ old('length_mm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="width_mm" id="width_mm" value="{{ old('width_mm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="height_mm" id="height_mm" value="{{ old('height_mm', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="weight_g" id="weight_g" value="{{ old('weight_g', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_optional" id="is_optional" value="1" {{ old('is_optional', 0) == 1 ? 'checked' : '' }}>
