    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.raw-materials.update", [$rawMaterial->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.rawMaterial.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $rawMaterial->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="notes" id="notes">{!! old('notes', $rawMaterial->notes) !!}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_vegan" id="is_vegan" value="1" {{ $rawMaterial->is_vegan || old('is_vegan', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_sustainable" id="is_sustainable" value="1" {{ $rawMaterial->is_sustainable || old('is_sustainable', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_ukfr_std" id="is_ukfr_std" value="1" {{ $rawMaterial->is_ukfr_std || old('is_ukfr_std', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_ukfr_treatable" id="is_ukfr_treatable" value="1" {{ $rawMaterial->is_ukfr_treatable || old('is_ukfr_treatable', 0) === 1 ? 'checked' : '' }}>
