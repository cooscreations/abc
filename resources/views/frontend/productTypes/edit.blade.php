                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-types.update", [$productType->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $productType->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $productType->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_url" id="public_url" value="{{ old('public_url', $productType->public_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_icon_url" id="public_icon_url" value="{{ old('public_icon_url', $productType->public_icon_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="list_order" id="list_order" value="{{ old('list_order', $productType->list_order) }}" step="1">
