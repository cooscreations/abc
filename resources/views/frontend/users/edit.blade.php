                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="nda_sign_date" id="nda_sign_date" value="{{ old('nda_sign_date', $user->nda_sign_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="honesty_sign_date" id="honesty_sign_date" value="{{ old('honesty_sign_date', $user->honesty_sign_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="private_notes" id="private_notes">{{ old('private_notes', $user->private_notes) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="public_bio" id="public_bio">{{ old('public_bio', $user->public_bio) }}</textarea>
