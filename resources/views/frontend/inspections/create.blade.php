    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.inspections.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_order_number" id="afa_order_number" value="{{ old('afa_order_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_inspected" id="qty_inspected" value="{{ old('qty_inspected', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="inspection_passed" id="inspection_passed" value="1" required {{ old('inspection_passed', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="inspection_planned_date" id="inspection_planned_date" value="{{ old('inspection_planned_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="actual_start_date" id="actual_start_date" value="{{ old('actual_start_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="crd_inspection_complete_date" id="crd_inspection_complete_date" value="{{ old('crd_inspection_complete_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_days_inspection_open" id="total_days_inspection_open" value="{{ old('total_days_inspection_open', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_days_on_site" id="total_days_on_site" value="{{ old('total_days_on_site', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="qc_report_received" id="qc_report_received" value="{{ old('qc_report_received') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="qe_audit_complete_date" id="qe_audit_complete_date" value="{{ old('qe_audit_complete_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="qc_report_sent_to_customer_date" id="qc_report_sent_to_customer_date" value="{{ old('qc_report_sent_to_customer_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sharepoint_photos_url" id="sharepoint_photos_url" value="{{ old('sharepoint_photos_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fabric_received_date" id="fabric_received_date" value="{{ old('fabric_received_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="inspector_private_notes" id="inspector_private_notes">{{ old('inspector_private_notes') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="public_notes" id="public_notes">{{ old('public_notes') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="qc_paid_date" id="qc_paid_date" value="{{ old('qc_paid_date') }}">
