    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bed-sizes-by-regions.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="size_code" id="size_code" value="{{ old('size_code', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_w_mm" id="mattress_w_mm" value="{{ old('mattress_w_mm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_l_mm" id="mattress_l_mm" value="{{ old('mattress_l_mm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="imperial_l_ft_in" id="imperial_l_ft_in" value="{{ old('imperial_l_ft_in', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="imperial_w_ft_in" id="imperial_w_ft_in" value="{{ old('imperial_w_ft_in', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="imperial_nickname" id="imperial_nickname" value="{{ old('imperial_nickname', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="plank_approx_extra_usd" id="plank_approx_extra_usd" value="{{ old('plank_approx_extra_usd', '0.00') }}" step="0.01">
