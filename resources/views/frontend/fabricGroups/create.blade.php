    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.fabric-groups.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_fabric_group_code" id="afa_fabric_group_code" value="{{ old('afa_fabric_group_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="primary_supplier_group_code" id="primary_supplier_group_code" value="{{ old('primary_supplier_group_code', '') }}">
