    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-collections.update", [$productCollection->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.productCollection.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $productCollection->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_logo_url" id="public_logo_url" value="{{ old('public_logo_url', $productCollection->public_logo_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_url" id="public_url" value="{{ old('public_url', $productCollection->public_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="share_point_url" id="share_point_url" value="{{ old('share_point_url', $productCollection->share_point_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="list_order" id="list_order" value="{{ old('list_order', $productCollection->list_order) }}" step="1">
