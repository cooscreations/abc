                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.complaint-statuses.update", [$complaintStatus->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $complaintStatus->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $complaintStatus->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="list_order" id="list_order" value="{{ old('list_order', $complaintStatus->list_order) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="color_code" id="color_code" value="{{ old('color_code', $complaintStatus->color_code) }}">
