                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.complaints.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="afa_case_number" id="afa_case_number" value="{{ old('afa_case_number', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_affected" id="qty_affected" value="{{ old('qty_affected', '') }}" step="1" required>
