    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.user-types.update", [$userType->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.userType.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $userType->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="list_order" id="list_order" value="{{ old('list_order', $userType->list_order) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auth_level" id="auth_level" value="{{ old('auth_level', $userType->auth_level) }}">
