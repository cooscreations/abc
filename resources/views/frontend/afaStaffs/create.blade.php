    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.afa-staffs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_started" id="date_started" value="{{ old('date_started') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_finished" id="date_finished" value="{{ old('date_finished') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="staff_bio" id="staff_bio">{{ old('staff_bio') }}</textarea>
