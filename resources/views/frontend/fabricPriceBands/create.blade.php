    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.fabric-price-bands.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="band_letter" id="band_letter" value="{{ old('band_letter', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cny_start_price" id="cny_start_price" value="{{ old('cny_start_price', '0.00') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cny_finish_price" id="cny_finish_price" value="{{ old('cny_finish_price', '0.00') }}" step="0.01" required>
