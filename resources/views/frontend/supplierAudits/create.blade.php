        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.supplierAudit.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.supplier-audits.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="inspector_id" id="inspector_id" required>
                                @foreach($inspectors as $id => $entry)
                                    <option value="{{ $id }}" {{ old('inspector_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="audit_date" id="audit_date" value="{{ old('audit_date') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="passed_audit" id="passed_audit" value="1" {{ old('passed_audit', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_land_sqm" id="total_land_sqm" value="{{ old('total_land_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="factory_area_sqm" id="factory_area_sqm" value="{{ old('factory_area_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="production_area_sqm" id="production_area_sqm" value="{{ old('production_area_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="inspection_area_sqm" id="inspection_area_sqm" value="{{ old('inspection_area_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="packing_area_sqm" id="packing_area_sqm" value="{{ old('packing_area_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="warehouse_area_sqm" id="warehouse_area_sqm" value="{{ old('warehouse_area_sqm', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_process_workers" id="qty_process_workers" value="{{ old('qty_process_workers', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_admin_supervisors" id="qty_admin_supervisors" value="{{ old('qty_admin_supervisors', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_r_and_d_staff" id="qty_r_and_d_staff" value="{{ old('qty_r_and_d_staff', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_technicians" id="qty_technicians" value="{{ old('qty_technicians', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_inline_qc" id="qty_inline_qc" value="{{ old('qty_inline_qc', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_final_qc" id="qty_final_qc" value="{{ old('qty_final_qc', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_packing_staff" id="qty_packing_staff" value="{{ old('qty_packing_staff', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_total_staff" id="qty_total_staff" value="{{ old('qty_total_staff', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_production_sites" id="qty_production_sites" value="{{ old('qty_production_sites', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_self_owned" id="is_self_owned" value="1" {{ old('is_self_owned', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_english_speaking_staff" id="has_english_speaking_staff" value="1" {{ old('has_english_speaking_staff', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="annual_domestic_turnover_usd" id="annual_domestic_turnover_usd" value="{{ old('annual_domestic_turnover_usd', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="annual_international_turnover_usd" id="annual_international_turnover_usd" value="{{ old('annual_international_turnover_usd', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="export_countries[]" id="export_countries" multiple>
                                @foreach($export_countries as $id => $export_countries)
                                    <option value="{{ $id }}" {{ in_array($id, old('export_countries', [])) ? 'selected' : '' }}>{{ $export_countries }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_social_iso_9001" id="has_social_iso_9001" value="1" {{ old('has_social_iso_9001', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_production_iso_9001" id="has_production_iso_9001" value="1" {{ old('has_production_iso_9001', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_hrs_per_day" id="qty_hrs_per_day" value="{{ old('qty_hrs_per_day', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_hrs_per_week" id="qty_hrs_per_week" value="{{ old('qty_hrs_per_week', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_work_days_per_month" id="qty_work_days_per_month" value="{{ old('qty_work_days_per_month', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ppe_provided" id="ppe_provided" value="1" {{ old('ppe_provided', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ppe_used" id="ppe_used" value="1" {{ old('ppe_used', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="safe_chemical_storage" id="safe_chemical_storage" value="1" {{ old('safe_chemical_storage', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wood_moisture" id="wood_moisture" value="{{ old('wood_moisture', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wood_drying" id="wood_drying" value="{{ old('wood_drying', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wood_quality" id="wood_quality" value="{{ old('wood_quality', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wood_storage" id="wood_storage" value="{{ old('wood_storage', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="ukfr_cali_foam_ok" id="ukfr_cali_foam_ok" value="1" {{ old('ukfr_cali_foam_ok', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="foam_density" id="foam_density" value="{{ old('foam_density', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="foam_identification" id="foam_identification" value="{{ old('foam_identification', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="composite_wood_identification" id="composite_wood_identification" value="{{ old('composite_wood_identification', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="passed_pu_pvc_reach_phthalat" id="passed_pu_pvc_reach_phthalat" value="1" {{ old('passed_pu_pvc_reach_phthalat', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="passed_silica_gel_bag_dmf" id="passed_silica_gel_bag_dmf" value="1" {{ old('passed_silica_gel_bag_dmf', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="passed_mdf_pw_pb" id="passed_mdf_pw_pb" value="1" {{ old('passed_mdf_pw_pb', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="subcontracted_items" id="subcontracted_items">{{ old('subcontracted_items') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_major_subcontractors" id="qty_major_subcontractors" value="{{ old('qty_major_subcontractors', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_subcontractors_per_component" id="qty_subcontractors_per_component" value="{{ old('qty_subcontractors_per_component', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="avg_num_yrs_with_subcontractors" id="avg_num_yrs_with_subcontractors" value="{{ old('avg_num_yrs_with_subcontractors', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="regular_subcontractors" id="regular_subcontractors" value="1" {{ old('regular_subcontractors', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="month_cap_40_hq" id="month_cap_40_hq" value="{{ old('month_cap_40_hq', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="annual_cap_40_hq" id="annual_cap_40_hq" value="{{ old('annual_cap_40_hq', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="month_cap_40_hq_free" id="month_cap_40_hq_free" value="{{ old('month_cap_40_hq_free', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="moq_40_hq" id="moq_40_hq" value="{{ old('moq_40_hq', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="std_lead_time_days" id="std_lead_time_days" value="{{ old('std_lead_time_days', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sample_lead_time_days" id="sample_lead_time_days" value="{{ old('sample_lead_time_days', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="pass_qc_doc_audit" id="pass_qc_doc_audit" value="1" {{ old('pass_qc_doc_audit', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_full_iqc" id="has_full_iqc" value="1" {{ old('has_full_iqc', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_full_oqc" id="has_full_oqc" value="1" {{ old('has_full_oqc', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_reg_qc_training" id="has_reg_qc_training" value="1" {{ old('has_reg_qc_training', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="client_1_name" id="client_1_name" value="{{ old('client_1_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_1_country_id" id="client_1_country_id">
                                @foreach($client_1_countries as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_1_country_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_1_company_id" id="client_1_company_id">
                                @foreach($client_1_companies as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_1_company_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_1_product_types[]" id="client_1_product_types" multiple>
                                @foreach($client_1_product_types as $id => $client_1_product_type)
                                    <option value="{{ $id }}" {{ in_array($id, old('client_1_product_types', [])) ? 'selected' : '' }}>{{ $client_1_product_type }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="client_1_containers_month" id="client_1_containers_month" value="{{ old('client_1_containers_month', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="client_2_name" id="client_2_name" value="{{ old('client_2_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_2_country_id" id="client_2_country_id">
                                @foreach($client_2_countries as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_2_country_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_2_company_id" id="client_2_company_id">
                                @foreach($client_2_companies as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_2_company_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="client_2_product_type" id="client_2_product_type" value="{{ old('client_2_product_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="client_2_containers_month" id="client_2_containers_month" value="{{ old('client_2_containers_month', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="client_3_name" id="client_3_name" value="{{ old('client_3_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_3_country_id" id="client_3_country_id">
                                @foreach($client_3_countries as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_3_country_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="client_3_company_id" id="client_3_company_id">
                                @foreach($client_3_companies as $id => $entry)
                                    <option value="{{ $id }}" {{ old('client_3_company_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="client_3_product_type" id="client_3_product_type" value="{{ old('client_3_product_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="client_3_containers_month" id="client_3_containers_month" value="{{ old('client_3_containers_month', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="address_confirmed" id="address_confirmed" value="1" {{ old('address_confirmed', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="pay_minimum_wage" id="pay_minimum_wage" value="1" {{ old('pay_minimum_wage', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="withhold_salary" id="withhold_salary" value="1" {{ old('withhold_salary', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="overtime_rate_usd" id="overtime_rate_usd" value="{{ old('overtime_rate_usd', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="primary_materials_id" id="primary_materials_id">
                                @foreach($primary_materials as $id => $entry)
                                    <option value="{{ $id }}" {{ old('primary_materials_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
