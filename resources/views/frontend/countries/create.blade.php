                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.countries.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alpha_2" id="alpha_2" value="{{ old('alpha_2', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alpha_3" id="alpha_3" value="{{ old('alpha_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iso_number" id="iso_number" value="{{ old('iso_number', '') }}">
