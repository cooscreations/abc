                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.countries.update", [$country->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alpha_2" id="alpha_2" value="{{ old('alpha_2', $country->alpha_2) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alpha_3" id="alpha_3" value="{{ old('alpha_3', $country->alpha_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="world_region_id" id="world_region_id">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="notes" id="notes">{!! old('notes', $country->notes) !!}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wiki_url" id="wiki_url" value="{{ old('wiki_url', $country->wiki_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="default_currency_id" id="default_currency_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iso_number" id="iso_number" value="{{ old('iso_number', $country->iso_number) }}">
