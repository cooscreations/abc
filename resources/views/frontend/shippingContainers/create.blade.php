    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shipping-containers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="container_number">{{ trans('cruds.shippingContainer.fields.container_number') }}</label>
                            <input class="form-control" type="text" name="container_number" id="container_number" value="{{ old('container_number', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="est_loading_date" id="est_loading_date" value="{{ old('est_loading_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="actual_loading_date" id="actual_loading_date" value="{{ old('actual_loading_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="si_date" id="si_date" value="{{ old('si_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="estimated_time_of_departure" id="estimated_time_of_departure" value="{{ old('estimated_time_of_departure') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="eta" id="eta" value="{{ old('eta') }}">
                            @if($errors->has('eta'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('eta') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="copy_bl_rec_date" id="copy_bl_rec_date" value="{{ old('copy_bl_rec_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="docs_sent_date" id="docs_sent_date" value="{{ old('docs_sent_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="bl_release_date" id="bl_release_date" value="{{ old('bl_release_date') }}">
