    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bed-size-groups.update", [$bedSizeGroup->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.bedSizeGroup.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $bedSizeGroup->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="group_number" id="group_number" value="{{ old('group_number', $bedSizeGroup->group_number) }}" step="1" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_ukfr" id="is_ukfr" value="1" {{ $bedSizeGroup->is_ukfr || old('is_ukfr', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_min_w_mm" id="mattress_min_w_mm" value="{{ old('mattress_min_w_mm', $bedSizeGroup->mattress_min_w_mm) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_max_w_mm" id="mattress_max_w_mm" value="{{ old('mattress_max_w_mm', $bedSizeGroup->mattress_max_w_mm) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_min_l_mm" id="mattress_min_l_mm" value="{{ old('mattress_min_l_mm', $bedSizeGroup->mattress_min_l_mm) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mattress_max_l_mm" id="mattress_max_l_mm" value="{{ old('mattress_max_l_mm', $bedSizeGroup->mattress_max_l_mm) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="add_gl_approx_usd" id="add_gl_approx_usd" value="{{ old('add_gl_approx_usd', $bedSizeGroup->add_gl_approx_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="add_pt_approx_usd" id="add_pt_approx_usd" value="{{ old('add_pt_approx_usd', $bedSizeGroup->add_pt_approx_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="add_2_drawers_approx_usd" id="add_2_drawers_approx_usd" value="{{ old('add_2_drawers_approx_usd', $bedSizeGroup->add_2_drawers_approx_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="add_mailorder_pkg_approx_usd" id="add_mailorder_pkg_approx_usd" value="{{ old('add_mailorder_pkg_approx_usd', $bedSizeGroup->add_mailorder_pkg_approx_usd) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $bedSizeGroup->description) !!}</textarea>
