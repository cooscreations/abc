...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SupplierAudit">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.supplier-audits.index') }}",
    columns: [
...
{ data: 'passed_audit', name: 'passed_audit' },
{ data: 'qty_final_qc', name: 'qty_final_qc' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SupplierAudit').DataTable(dtOverrideGlobals);
