...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipping-containers.update", [$shippingContainer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="container_number">{{ trans('cruds.shippingContainer.fields.container_number') }}</label>
                <input class="form-control {{ $errors->has('container_number') ? 'is-invalid' : '' }}" type="text" name="container_number" id="container_number" value="{{ old('container_number', $shippingContainer->container_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('est_loading_date') ? 'is-invalid' : '' }}" type="text" name="est_loading_date" id="est_loading_date" value="{{ old('est_loading_date', $shippingContainer->est_loading_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('actual_loading_date') ? 'is-invalid' : '' }}" type="text" name="actual_loading_date" id="actual_loading_date" value="{{ old('actual_loading_date', $shippingContainer->actual_loading_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('booking_date') ? 'is-invalid' : '' }}" type="text" name="booking_date" id="booking_date" value="{{ old('booking_date', $shippingContainer->booking_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('so_date') ? 'is-invalid' : '' }}" type="text" name="so_date" id="so_date" value="{{ old('so_date', $shippingContainer->so_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('si_date') ? 'is-invalid' : '' }}" type="text" name="si_date" id="si_date" value="{{ old('si_date', $shippingContainer->si_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('estimated_time_of_departure') ? 'is-invalid' : '' }}" type="text" name="estimated_time_of_departure" id="estimated_time_of_departure" value="{{ old('estimated_time_of_departure', $shippingContainer->estimated_time_of_departure) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('copy_bl_rec_date') ? 'is-invalid' : '' }}" type="text" name="copy_bl_rec_date" id="copy_bl_rec_date" value="{{ old('copy_bl_rec_date', $shippingContainer->copy_bl_rec_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('docs_sent_date') ? 'is-invalid' : '' }}" type="text" name="docs_sent_date" id="docs_sent_date" value="{{ old('docs_sent_date', $shippingContainer->docs_sent_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('bl_release_date') ? 'is-invalid' : '' }}" type="text" name="bl_release_date" id="bl_release_date" value="{{ old('bl_release_date', $shippingContainer->bl_release_date) }}">
