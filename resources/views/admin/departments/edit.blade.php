    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.departments.update", [$department->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dept_code') ? 'is-invalid' : '' }}" type="text" name="dept_code" id="dept_code" value="{{ old('dept_code', $department->dept_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hex_color') ? 'is-invalid' : '' }}" type="text" name="hex_color" id="hex_color" value="{{ old('hex_color', $department->hex_color) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('dept_intro') ? 'is-invalid' : '' }}" name="dept_intro" id="dept_intro">{!! old('dept_intro', $department->dept_intro) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('manager') ? 'is-invalid' : '' }}" name="manager_id" id="manager_id">
                    @foreach($managers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('manager_id') ? old('manager_id') : $department->manager->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
