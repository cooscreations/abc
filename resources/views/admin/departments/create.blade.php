    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.departments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dept_code') ? 'is-invalid' : '' }}" type="text" name="dept_code" id="dept_code" value="{{ old('dept_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hex_color') ? 'is-invalid' : '' }}" type="text" name="hex_color" id="hex_color" value="{{ old('hex_color', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('dept_intro') ? 'is-invalid' : '' }}" name="dept_intro" id="dept_intro">{!! old('dept_intro') !!}</textarea>
