    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.addresses.update", [$address->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_line_1') ? 'is-invalid' : '' }}" type="text" name="add_line_1" id="add_line_1" value="{{ old('add_line_1', $address->add_line_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_line_2') ? 'is-invalid' : '' }}" type="text" name="add_line_2" id="add_line_2" value="{{ old('add_line_2', $address->add_line_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_line_3') ? 'is-invalid' : '' }}" type="text" name="add_line_3" id="add_line_3" value="{{ old('add_line_3', $address->add_line_3) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_billing_address') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_billing_address" id="is_billing_address" value="1" {{ $address->is_billing_address || old('is_billing_address', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_shipping_address') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_shipping_address" id="is_shipping_address" value="1" {{ $address->is_shipping_address || old('is_shipping_address', 0) === 1 ? 'checked' : '' }}>
