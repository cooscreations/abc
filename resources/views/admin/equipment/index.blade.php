...
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'manufacturer_company_name', name: 'manufacturer.company_name' },
{ data: 'equipment_type_name', name: 'equipment_type.name' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Equipment').DataTable(dtOverrideGlobals);
