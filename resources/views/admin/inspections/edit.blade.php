...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inspections.update", [$inspection->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('afa_order_number') ? 'is-invalid' : '' }}" type="text" name="afa_order_number" id="afa_order_number" value="{{ old('afa_order_number', $inspection->afa_order_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_order_number') ? 'is-invalid' : '' }}" type="text" name="customer_order_number" id="customer_order_number" value="{{ old('customer_order_number', $inspection->customer_order_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_inspected') ? 'is-invalid' : '' }}" type="number" name="qty_inspected" id="qty_inspected" value="{{ old('qty_inspected', $inspection->qty_inspected) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('inspection_passed') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="inspection_passed" id="inspection_passed" value="1" {{ $inspection->inspection_passed || old('inspection_passed', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('inspection_planned_date') ? 'is-invalid' : '' }}" type="text" name="inspection_planned_date" id="inspection_planned_date" value="{{ old('inspection_planned_date', $inspection->inspection_planned_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('actual_start_date') ? 'is-invalid' : '' }}" type="text" name="actual_start_date" id="actual_start_date" value="{{ old('actual_start_date', $inspection->actual_start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('crd_inspection_complete_date') ? 'is-invalid' : '' }}" type="text" name="crd_inspection_complete_date" id="crd_inspection_complete_date" value="{{ old('crd_inspection_complete_date', $inspection->crd_inspection_complete_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_days_inspection_open') ? 'is-invalid' : '' }}" type="number" name="total_days_inspection_open" id="total_days_inspection_open" value="{{ old('total_days_inspection_open', $inspection->total_days_inspection_open) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_days_on_site') ? 'is-invalid' : '' }}" type="number" name="total_days_on_site" id="total_days_on_site" value="{{ old('total_days_on_site', $inspection->total_days_on_site) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('qc_report_received') ? 'is-invalid' : '' }}" type="text" name="qc_report_received" id="qc_report_received" value="{{ old('qc_report_received', $inspection->qc_report_received) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('qe_audit_complete_date') ? 'is-invalid' : '' }}" type="text" name="qe_audit_complete_date" id="qe_audit_complete_date" value="{{ old('qe_audit_complete_date', $inspection->qe_audit_complete_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('qc_report_sent_to_customer_date') ? 'is-invalid' : '' }}" type="text" name="qc_report_sent_to_customer_date" id="qc_report_sent_to_customer_date" value="{{ old('qc_report_sent_to_customer_date', $inspection->qc_report_sent_to_customer_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sharepoint_photos_url') ? 'is-invalid' : '' }}" type="text" name="sharepoint_photos_url" id="sharepoint_photos_url" value="{{ old('sharepoint_photos_url', $inspection->sharepoint_photos_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fabric_received_date') ? 'is-invalid' : '' }}" type="text" name="fabric_received_date" id="fabric_received_date" value="{{ old('fabric_received_date', $inspection->fabric_received_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('inspector_private_notes') ? 'is-invalid' : '' }}" name="inspector_private_notes" id="inspector_private_notes">{{ old('inspector_private_notes', $inspection->inspector_private_notes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('public_notes') ? 'is-invalid' : '' }}" name="public_notes" id="public_notes">{{ old('public_notes', $inspection->public_notes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('qc_paid_date') ? 'is-invalid' : '' }}" type="text" name="qc_paid_date" id="qc_paid_date" value="{{ old('qc_paid_date', $inspection->qc_paid_date) }}">
