    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('afa_order_num') ? 'is-invalid' : '' }}" type="text" name="afa_order_num" id="afa_order_num" value="{{ old('afa_order_num', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('cust_order_date') ? 'is-invalid' : '' }}" type="text" name="cust_order_date" id="cust_order_date" value="{{ old('cust_order_date') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('order_status') ? 'is-invalid' : '' }}" name="order_status_id" id="order_status_id" required>
                    @foreach($order_statuses as $id => $entry)
                        <option value="{{ $id }}" {{ old('order_status_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('order_type') ? 'is-invalid' : '' }}" name="order_type_id" id="order_type_id">
                    @foreach($order_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('order_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ukfr') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ukfr" id="ukfr" value="1" {{ old('ukfr', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('order_placed_by') ? 'is-invalid' : '' }}" name="order_placed_by_id" id="order_placed_by_id" required>
                    @foreach($order_placed_bies as $id => $entry)
                        <option value="{{ $id }}" {{ old('order_placed_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shipping_agent') ? 'is-invalid' : '' }}" name="shipping_agent_id" id="shipping_agent_id">
                    @foreach($shipping_agents as $id => $entry)
                        <option value="{{ $id }}" {{ old('shipping_agent_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ship_from_port') ? 'is-invalid' : '' }}" name="ship_from_port_id" id="ship_from_port_id">
                    @foreach($ship_from_ports as $id => $entry)
                        <option value="{{ $id }}" {{ old('ship_from_port_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ship_to_port') ? 'is-invalid' : '' }}" name="ship_to_port_id" id="ship_to_port_id">
                    @foreach($ship_to_ports as $id => $entry)
                        <option value="{{ $id }}" {{ old('ship_to_port_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ship_to_address') ? 'is-invalid' : '' }}" name="ship_to_address_id" id="ship_to_address_id">
                    @foreach($ship_to_addresses as $id => $entry)
                        <option value="{{ $id }}" {{ old('ship_to_address_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bill_to_address') ? 'is-invalid' : '' }}" name="bill_to_address_id" id="bill_to_address_id">
                    @foreach($bill_to_addresses as $id => $entry)
                        <option value="{{ $id }}" {{ old('bill_to_address_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_value_placed_usd') ? 'is-invalid' : '' }}" type="number" name="pi_value_placed_usd" id="pi_value_placed_usd" value="{{ old('pi_value_placed_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ci_value_shipped_usd') ? 'is-invalid' : '' }}" type="number" name="ci_value_shipped_usd" id="ci_value_shipped_usd" value="{{ old('ci_value_shipped_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_deposit_value_usd') ? 'is-invalid' : '' }}" type="number" name="customer_deposit_value_usd" id="customer_deposit_value_usd" value="{{ old('customer_deposit_value_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_deposit_rate') ? 'is-invalid' : '' }}" type="number" name="customer_deposit_rate" id="customer_deposit_rate" value="{{ old('customer_deposit_rate', '20') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cust_dep_rec_date') ? 'is-invalid' : '' }}" type="text" name="cust_dep_rec_date" id="cust_dep_rec_date" value="{{ old('cust_dep_rec_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('order_sent_to_supplier_date') ? 'is-invalid' : '' }}" type="text" name="order_sent_to_supplier_date" id="order_sent_to_supplier_date" value="{{ old('order_sent_to_supplier_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowance_usd') ? 'is-invalid' : '' }}" type="number" name="allowance_usd" id="allowance_usd" value="{{ old('allowance_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('customer_required_ship_date') ? 'is-invalid' : '' }}" type="text" name="customer_required_ship_date" id="customer_required_ship_date" value="{{ old('customer_required_ship_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('crd_target_date') ? 'is-invalid' : '' }}" type="text" name="crd_target_date" id="crd_target_date" value="{{ old('crd_target_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('quality_control_staffs') ? 'is-invalid' : '' }}" name="quality_control_staffs[]" id="quality_control_staffs" multiple>
                    @foreach($quality_control_staffs as $id => $quality_control_staff)
                        <option value="{{ $id }}" {{ in_array($id, old('quality_control_staffs', [])) ? 'selected' : '' }}>{{ $quality_control_staff }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_balance_usd') ? 'is-invalid' : '' }}" type="number" name="customer_balance_usd" id="customer_balance_usd" value="{{ old('customer_balance_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('balance_received_date') ? 'is-invalid' : '' }}" type="text" name="balance_received_date" id="balance_received_date" value="{{ old('balance_received_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('po_value_placed_usd') ? 'is-invalid' : '' }}" type="number" name="po_value_placed_usd" id="po_value_placed_usd" value="{{ old('po_value_placed_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('po_value_shipped_usd') ? 'is-invalid' : '' }}" type="number" name="po_value_shipped_usd" id="po_value_shipped_usd" value="{{ old('po_value_shipped_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supplier_deposit_usd') ? 'is-invalid' : '' }}" type="number" name="supplier_deposit_usd" id="supplier_deposit_usd" value="{{ old('supplier_deposit_usd', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('supplier_deposit_paid_date') ? 'is-invalid' : '' }}" type="text" name="supplier_deposit_paid_date" id="supplier_deposit_paid_date" value="{{ old('supplier_deposit_paid_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('handling_charge_and_allowance_usd') ? 'is-invalid' : '' }}" type="number" name="handling_charge_and_allowance_usd" id="handling_charge_and_allowance_usd" value="{{ old('handling_charge_and_allowance_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('documents_received_date') ? 'is-invalid' : '' }}" type="text" name="documents_received_date" id="documents_received_date" value="{{ old('documents_received_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supplier_balance_usd') ? 'is-invalid' : '' }}" type="number" name="supplier_balance_usd" id="supplier_balance_usd" value="{{ old('supplier_balance_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('supplier_balance_paid_date') ? 'is-invalid' : '' }}" type="text" name="supplier_balance_paid_date" id="supplier_balance_paid_date" value="{{ old('supplier_balance_paid_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission_usd') ? 'is-invalid' : '' }}" type="number" name="commission_usd" id="commission_usd" value="{{ old('commission_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('commission_paid_date') ? 'is-invalid' : '' }}" type="text" name="commission_paid_date" id="commission_paid_date" value="{{ old('commission_paid_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('packaging_type') ? 'is-invalid' : '' }}" name="packaging_type_id" id="packaging_type_id">
                    @foreach($packaging_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('packaging_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('req_fumigtion') ? 'is-invalid' : '' }}" type="text" name="req_fumigtion" id="req_fumigtion" value="{{ old('req_fumigtion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fumigation_cost_usd') ? 'is-invalid' : '' }}" type="number" name="fumigation_cost_usd" id="fumigation_cost_usd" value="{{ old('fumigation_cost_usd', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profit_usd') ? 'is-invalid' : '' }}" type="number" name="profit_usd" id="profit_usd" value="{{ old('profit_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profit_ratio') ? 'is-invalid' : '' }}" type="number" name="profit_ratio" id="profit_ratio" value="{{ old('profit_ratio', '0.00') }}" step="0.01" max="100">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fn_audit_complete_date') ? 'is-invalid' : '' }}" type="text" name="fn_audit_complete_date" id="fn_audit_complete_date" value="{{ old('fn_audit_complete_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_days_to_complete') ? 'is-invalid' : '' }}" type="number" name="total_days_to_complete" id="total_days_to_complete" value="{{ old('total_days_to_complete', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_tolerance') ? 'is-invalid' : '' }}" type="number" name="qty_tolerance" id="qty_tolerance" value="{{ old('qty_tolerance', '10') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('size_tolerance') ? 'is-invalid' : '' }}" type="number" name="size_tolerance" id="size_tolerance" value="{{ old('size_tolerance', '20') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leadtime_days') ? 'is-invalid' : '' }}" type="text" name="leadtime_days" id="leadtime_days" value="{{ old('leadtime_days', '65 - 80') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cny_to_usd_rate_today') ? 'is-invalid' : '' }}" type="number" name="cny_to_usd_rate_today" id="cny_to_usd_rate_today" value="{{ old('cny_to_usd_rate_today', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('price_expiry_date') ? 'is-invalid' : '' }}" type="text" name="price_expiry_date" id="price_expiry_date" value="{{ old('price_expiry_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('afa_bank_account_to_pay') ? 'is-invalid' : '' }}" name="afa_bank_account_to_pay_id" id="afa_bank_account_to_pay_id">
                    @foreach($afa_bank_account_to_pays as $id => $entry)
                        <option value="{{ $id }}" {{ old('afa_bank_account_to_pay_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
