    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-types.update", [$productType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $productType->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $productType->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('public_url') ? 'is-invalid' : '' }}" type="text" name="public_url" id="public_url" value="{{ old('public_url', $productType->public_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('public_icon_url') ? 'is-invalid' : '' }}" type="text" name="public_icon_url" id="public_icon_url" value="{{ old('public_icon_url', $productType->public_icon_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('list_order') ? 'is-invalid' : '' }}" type="number" name="list_order" id="list_order" value="{{ old('list_order', $productType->list_order) }}" step="1">
