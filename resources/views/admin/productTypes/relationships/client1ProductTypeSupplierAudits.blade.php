...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-client1ProductTypeSupplierAudits">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-client1ProductTypeSupplierAudits:not(.ajaxTable)').DataTable({ buttons: dtButtons })
