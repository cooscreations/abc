...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-primaryCompanyTypeContactCompanies">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($contactCompanies as $key => $contactCompany)
                        <tr data-entry-id="{{ $contactCompany->id }}">
                            ...
                            <td>
                                {{ $contactCompany->primary_company_type->icon ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-primaryCompanyTypeContactCompanies:not(.ajaxTable)').DataTable({ buttons: dtButtons })
