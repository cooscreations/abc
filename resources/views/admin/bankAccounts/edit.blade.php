    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bank-accounts.update", [$bankAccount->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $bankAccount->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $bankAccount->bank_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary') ? 'is-invalid' : '' }}" type="text" name="beneficiary" id="beneficiary" value="{{ old('beneficiary', $bankAccount->beneficiary) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_number') ? 'is-invalid' : '' }}" type="text" name="account_number" id="account_number" value="{{ old('account_number', $bankAccount->account_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swift_code') ? 'is-invalid' : '' }}" type="text" name="swift_code" id="swift_code" value="{{ old('swift_code', $bankAccount->swift_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tlx_number') ? 'is-invalid' : '' }}" type="text" name="tlx_number" id="tlx_number" value="{{ old('tlx_number', $bankAccount->tlx_number) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('default_comment_on_tnx') ? 'is-invalid' : '' }}" name="default_comment_on_tnx" id="default_comment_on_tnx">{{ old('default_comment_on_tnx', $bankAccount->default_comment_on_tnx) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('internal_notes') ? 'is-invalid' : '' }}" name="internal_notes" id="internal_notes">{{ old('internal_notes', $bankAccount->internal_notes) }}</textarea>
