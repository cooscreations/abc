...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.component-parts.update", [$componentPart->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $componentPart->quantity) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_fabric_finish_choice') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_fabric_finish_choice" id="has_fabric_finish_choice" value="1" {{ $componentPart->has_fabric_finish_choice || old('has_fabric_finish_choice', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_sub_assembly') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_sub_assembly" id="is_sub_assembly" value="1" {{ $componentPart->is_sub_assembly || old('is_sub_assembly', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('length_mm') ? 'is-invalid' : '' }}" type="number" name="length_mm" id="length_mm" value="{{ old('length_mm', $componentPart->length_mm) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('width_mm') ? 'is-invalid' : '' }}" type="number" name="width_mm" id="width_mm" value="{{ old('width_mm', $componentPart->width_mm) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height_mm') ? 'is-invalid' : '' }}" type="text" name="height_mm" id="height_mm" value="{{ old('height_mm', $componentPart->height_mm) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight_g') ? 'is-invalid' : '' }}" type="number" name="weight_g" id="weight_g" value="{{ old('weight_g', $componentPart->weight_g) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_optional') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_optional" id="is_optional" value="1" {{ $componentPart->is_optional || old('is_optional', 0) === 1 ? 'checked' : '' }}>
