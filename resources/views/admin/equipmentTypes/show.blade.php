...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#equipment_type_equipment" role="tab" data-toggle="tab">
                {{ trans('cruds.equipment.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="equipment_type_equipment">
            @includeIf('admin.equipmentTypes.relationships.equipmentTypeEquipment', ['equipment' => $equipmentType->equipmentTypeEquipment])
        </div>
    </div>
</div>
