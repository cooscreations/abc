    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_email') ? 'is-invalid' : '' }}" type="text" name="personal_email" id="personal_email" value="{{ old('personal_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_url') ? 'is-invalid' : '' }}" type="text" name="personal_url" id="personal_url" value="{{ old('personal_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nda_signed_date') ? 'is-invalid' : '' }}" type="text" name="nda_signed_date" id="nda_signed_date" value="{{ old('nda_signed_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('honesty_agreement_signed_date') ? 'is-invalid' : '' }}" type="text" name="honesty_agreement_signed_date" id="honesty_agreement_signed_date" value="{{ old('honesty_agreement_signed_date') }}">
