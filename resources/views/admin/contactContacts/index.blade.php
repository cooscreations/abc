...
{ data: 'current_country_alpha_2', name: 'current_country.alpha_2' },
{ data: 'current_country.name', name: 'current_country.name' },
{ data: 'company_company_name', name: 'company.company_name' },
{ data: 'photo', name: 'photo', sortable: false, searchable: false },
{ data: 'contact_email', name: 'contact_email' },
{ data: 'mobile_phone', name: 'mobile_phone' },
{ data: 'default_language_alpha_2', name: 'default_language.alpha_2' },
{ data: 'default_language.name', name: 'default_language.name' },
