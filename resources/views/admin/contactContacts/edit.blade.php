    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $contactContact->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $contactContact->title) }}">
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $contactContact->full_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('local_name') ? 'is-invalid' : '' }}" type="text" name="local_name" id="local_name" value="{{ old('local_name', $contactContact->local_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country_of_birth') ? 'is-invalid' : '' }}" name="country_of_birth_id" id="country_of_birth_id">
                    @foreach($country_of_births as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_of_birth_id') ? old('country_of_birth_id') : $contactContact->country_of_birth->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('primary_address') ? 'is-invalid' : '' }}" name="primary_address_id" id="primary_address_id">
                    @foreach($primary_addresses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('primary_address_id') ? old('primary_address_id') : $contactContact->primary_address->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('current_country') ? 'is-invalid' : '' }}" name="current_country_id" id="current_country_id">
                    @foreach($current_countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('current_country_id') ? old('current_country_id') : $contactContact->current_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wechat') ? 'is-invalid' : '' }}" type="text" name="wechat" id="wechat" value="{{ old('wechat', $contactContact->wechat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin_url') ? 'is-invalid' : '' }}" type="text" name="linkedin_url" id="linkedin_url" value="{{ old('linkedin_url', $contactContact->linkedin_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_email') ? 'is-invalid' : '' }}" type="text" name="personal_email" id="personal_email" value="{{ old('personal_email', $contactContact->personal_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_phone') ? 'is-invalid' : '' }}" type="text" name="office_phone" id="office_phone" value="{{ old('office_phone', $contactContact->office_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_phone') ? 'is-invalid' : '' }}" type="text" name="mobile_phone" id="mobile_phone" value="{{ old('mobile_phone', $contactContact->mobile_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_url') ? 'is-invalid' : '' }}" type="text" name="personal_url" id="personal_url" value="{{ old('personal_url', $contactContact->personal_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $contactContact->date_of_birth) }}">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('business_card') ? 'is-invalid' : '' }}" id="business_card-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('qr_code') ? 'is-invalid' : '' }}" id="qr_code-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('default_language') ? 'is-invalid' : '' }}" name="default_language_id" id="default_language_id">
                    @foreach($default_languages as $id => $entry)
                        <option value="{{ $id }}" {{ (old('default_language_id') ? old('default_language_id') : $contactContact->default_language->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles[]" id="roles" multiple>
                    @foreach($roles as $id => $roles)
                        <option value="{{ $id }}" {{ (in_array($id, old('roles', [])) || $contactContact->roles->contains($id)) ? 'selected' : '' }}>{{ $roles }}</option>
                    @endforeach
                </select>
                @if($errors->has('roles'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nda_signed_date') ? 'is-invalid' : '' }}" type="text" name="nda_signed_date" id="nda_signed_date" value="{{ old('nda_signed_date', $contactContact->nda_signed_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('honesty_agreement_signed_date') ? 'is-invalid' : '' }}" type="text" name="honesty_agreement_signed_date" id="honesty_agreement_signed_date" value="{{ old('honesty_agreement_signed_date', $contactContact->honesty_agreement_signed_date) }}">
