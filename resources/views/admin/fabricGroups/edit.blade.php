...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fabric-groups.update", [$fabricGroup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.fabricGroup.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $fabricGroup->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('afa_fabric_group_code') ? 'is-invalid' : '' }}" type="text" name="afa_fabric_group_code" id="afa_fabric_group_code" value="{{ old('afa_fabric_group_code', $fabricGroup->afa_fabric_group_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_supplier_group_code') ? 'is-invalid' : '' }}" type="text" name="primary_supplier_group_code" id="primary_supplier_group_code" value="{{ old('primary_supplier_group_code', $fabricGroup->primary_supplier_group_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sharepoint_url') ? 'is-invalid' : '' }}" type="text" name="sharepoint_url" id="sharepoint_url" value="{{ old('sharepoint_url', $fabricGroup->sharepoint_url) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $fabricGroup->description) !!}</textarea>
