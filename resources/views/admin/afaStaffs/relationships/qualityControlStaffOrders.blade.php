...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-qualityControlStaffOrders">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-qualityControlStaffOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
