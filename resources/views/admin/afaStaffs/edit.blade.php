...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.afa-staffs.update", [$afaStaff->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="full_name">{{ trans('cruds.afaStaff.fields.full_name') }}</label>
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $afaStaff->full_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_started') ? 'is-invalid' : '' }}" type="text" name="date_started" id="date_started" value="{{ old('date_started', $afaStaff->date_started) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_finished') ? 'is-invalid' : '' }}" type="text" name="date_finished" id="date_finished" value="{{ old('date_finished', $afaStaff->date_finished) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('staff_bio') ? 'is-invalid' : '' }}" name="staff_bio" id="staff_bio">{{ old('staff_bio', $afaStaff->staff_bio) }}</textarea>
