...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bed-size-groups.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('group_number') ? 'is-invalid' : '' }}" type="number" name="group_number" id="group_number" value="{{ old('group_number', '') }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_ukfr') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_ukfr" id="is_ukfr" value="1" {{ old('is_ukfr', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_min_w_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_min_w_mm" id="mattress_min_w_mm" value="{{ old('mattress_min_w_mm', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_max_w_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_max_w_mm" id="mattress_max_w_mm" value="{{ old('mattress_max_w_mm', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_min_l_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_min_l_mm" id="mattress_min_l_mm" value="{{ old('mattress_min_l_mm', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_max_l_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_max_l_mm" id="mattress_max_l_mm" value="{{ old('mattress_max_l_mm', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_gl_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_gl_approx_usd" id="add_gl_approx_usd" value="{{ old('add_gl_approx_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_pt_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_pt_approx_usd" id="add_pt_approx_usd" value="{{ old('add_pt_approx_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_2_drawers_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_2_drawers_approx_usd" id="add_2_drawers_approx_usd" value="{{ old('add_2_drawers_approx_usd', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_mailorder_pkg_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_mailorder_pkg_approx_usd" id="add_mailorder_pkg_approx_usd" value="{{ old('add_mailorder_pkg_approx_usd', '0.00') }}" step="0.01">
