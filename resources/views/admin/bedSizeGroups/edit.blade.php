...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bedSizeGroup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bed-size-groups.update", [$bedSizeGroup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.bedSizeGroup.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $bedSizeGroup->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('price_group') ? 'is-invalid' : '' }}" name="price_group_id" id="price_group_id" required>
                    @foreach($price_groups as $id => $entry)
                        <option value="{{ $id }}" {{ (old('price_group_id') ? old('price_group_id') : $bedSizeGroup->price_group->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('group_number') ? 'is-invalid' : '' }}" type="number" name="group_number" id="group_number" value="{{ old('group_number', $bedSizeGroup->group_number) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_ukfr') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="is_ukfr" value="0">
                    <input class="form-check-input" type="checkbox" name="is_ukfr" id="is_ukfr" value="1" {{ $bedSizeGroup->is_ukfr || old('is_ukfr', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_ukfr">{{ trans('cruds.bedSizeGroup.fields.is_ukfr') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_min_w_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_min_w_mm" id="mattress_min_w_mm" value="{{ old('mattress_min_w_mm', $bedSizeGroup->mattress_min_w_mm) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_max_w_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_max_w_mm" id="mattress_max_w_mm" value="{{ old('mattress_max_w_mm', $bedSizeGroup->mattress_max_w_mm) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_min_l_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_min_l_mm" id="mattress_min_l_mm" value="{{ old('mattress_min_l_mm', $bedSizeGroup->mattress_min_l_mm) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_max_l_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_max_l_mm" id="mattress_max_l_mm" value="{{ old('mattress_max_l_mm', $bedSizeGroup->mattress_max_l_mm) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_gl_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_gl_approx_usd" id="add_gl_approx_usd" value="{{ old('add_gl_approx_usd', $bedSizeGroup->add_gl_approx_usd) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_pt_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_pt_approx_usd" id="add_pt_approx_usd" value="{{ old('add_pt_approx_usd', $bedSizeGroup->add_pt_approx_usd) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_2_drawers_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_2_drawers_approx_usd" id="add_2_drawers_approx_usd" value="{{ old('add_2_drawers_approx_usd', $bedSizeGroup->add_2_drawers_approx_usd) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_mailorder_pkg_approx_usd') ? 'is-invalid' : '' }}" type="number" name="add_mailorder_pkg_approx_usd" id="add_mailorder_pkg_approx_usd" value="{{ old('add_mailorder_pkg_approx_usd', $bedSizeGroup->add_mailorder_pkg_approx_usd) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $bedSizeGroup->description) !!}</textarea>
