...
@can('component_part_name_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.component-part-names.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ComponentPartName">
            <thead>
                <tr>
                    <th width="10">
...
@can('component_part_name_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.component-part-names.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.component-part-names.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ComponentPartName').DataTable(dtOverrideGlobals);
