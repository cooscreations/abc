...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-collections.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('public_logo_url') ? 'is-invalid' : '' }}" type="text" name="public_logo_url" id="public_logo_url" value="{{ old('public_logo_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('share_point_url') ? 'is-invalid' : '' }}" type="text" name="share_point_url" id="share_point_url" value="{{ old('share_point_url', '') }}">
