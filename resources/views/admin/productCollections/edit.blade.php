...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.productCollection.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-collections.update", [$productCollection->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.productCollection.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $productCollection->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('public_logo_url') ? 'is-invalid' : '' }}" type="text" name="public_logo_url" id="public_logo_url" value="{{ old('public_logo_url', $productCollection->public_logo_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('public_url') ? 'is-invalid' : '' }}" type="text" name="public_url" id="public_url" value="{{ old('public_url', $productCollection->public_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('share_point_url') ? 'is-invalid' : '' }}" type="text" name="share_point_url" id="share_point_url" value="{{ old('share_point_url', $productCollection->share_point_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('list_order') ? 'is-invalid' : '' }}" type="number" name="list_order" id="list_order" value="{{ old('list_order', $productCollection->list_order) }}" step="1">
