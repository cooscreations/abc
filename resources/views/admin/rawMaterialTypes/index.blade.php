...
@can('raw_material_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.raw-material-types.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-RawMaterialType">
            <thead>
                <tr>
                    <th width="10">
...
@can('raw_material_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.raw-material-types.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.raw-material-types.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-RawMaterialType').DataTable(dtOverrideGlobals);
