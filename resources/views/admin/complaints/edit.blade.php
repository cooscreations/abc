    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.complaints.update", [$complaint->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('afa_case_number') ? 'is-invalid' : '' }}" type="text" name="afa_case_number" id="afa_case_number" value="{{ old('afa_case_number', $complaint->afa_case_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_affected') ? 'is-invalid' : '' }}" type="number" name="qty_affected" id="qty_affected" value="{{ old('qty_affected', $complaint->qty_affected) }}" step="1" required>
