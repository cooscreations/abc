...
@can('product_size_name_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.product-size-names.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ProductSizeName">
            <thead>
                <tr>
                    <th width="10">
...
@can('product_size_name_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.product-size-names.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.product-size-names.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ProductSizeName').DataTable(dtOverrideGlobals);
