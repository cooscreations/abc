...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bed-sizes-by-regions.update", [$bedSizesByRegion->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.bedSizesByRegion.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $bedSizesByRegion->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('size_code') ? 'is-invalid' : '' }}" type="text" name="size_code" id="size_code" value="{{ old('size_code', $bedSizesByRegion->size_code) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $bedSizesByRegion->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_w_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_w_mm" id="mattress_w_mm" value="{{ old('mattress_w_mm', $bedSizesByRegion->mattress_w_mm) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mattress_l_mm') ? 'is-invalid' : '' }}" type="number" name="mattress_l_mm" id="mattress_l_mm" value="{{ old('mattress_l_mm', $bedSizesByRegion->mattress_l_mm) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imperial_l_ft_in') ? 'is-invalid' : '' }}" type="text" name="imperial_l_ft_in" id="imperial_l_ft_in" value="{{ old('imperial_l_ft_in', $bedSizesByRegion->imperial_l_ft_in) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imperial_w_ft_in') ? 'is-invalid' : '' }}" type="text" name="imperial_w_ft_in" id="imperial_w_ft_in" value="{{ old('imperial_w_ft_in', $bedSizesByRegion->imperial_w_ft_in) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imperial_nickname') ? 'is-invalid' : '' }}" type="text" name="imperial_nickname" id="imperial_nickname" value="{{ old('imperial_nickname', $bedSizesByRegion->imperial_nickname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plank_approx_extra_usd') ? 'is-invalid' : '' }}" type="number" name="plank_approx_extra_usd" id="plank_approx_extra_usd" value="{{ old('plank_approx_extra_usd', $bedSizesByRegion->plank_approx_extra_usd) }}" step="0.01">
