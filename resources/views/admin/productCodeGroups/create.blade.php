...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-code-groups.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('range_start') ? 'is-invalid' : '' }}" type="text" name="range_start" id="range_start" value="{{ old('range_start', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('range_end') ? 'is-invalid' : '' }}" type="text" name="range_end" id="range_end" value="{{ old('range_end', '') }}">
