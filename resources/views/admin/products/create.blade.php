    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('afa_model_number') ? 'is-invalid' : '' }}" type="text" name="afa_model_number" id="afa_model_number" value="{{ old('afa_model_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_launched') ? 'is-invalid' : '' }}" type="text" name="date_launched" id="date_launched" value="{{ old('date_launched') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('std_qty_feet') ? 'is-invalid' : '' }}" type="number" name="std_qty_feet" id="std_qty_feet" value="{{ old('std_qty_feet', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('std_qty_boxes') ? 'is-invalid' : '' }}" type="text" name="std_qty_boxes" id="std_qty_boxes" value="{{ old('std_qty_boxes', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('public_description') ? 'is-invalid' : '' }}" name="public_description" id="public_description">{!! old('public_description') !!}</textarea>
