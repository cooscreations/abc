                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($product_collections as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'afa_model_number', name: 'afa_model_number' },
{ data: 'product_collection_name', name: 'product_collection.name' },
{ data: 'default_group_name', name: 'default_group.name' },
{ data: 'primary_suppliers', name: 'primary_suppliers.company_short_code' },
