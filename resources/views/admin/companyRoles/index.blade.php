...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CompanyRole">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.company-roles.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'company_company_name', name: 'company.company_name' },
{ data: 'role_title', name: 'role.title' },
{ data: 'contact_contact_first_name', name: 'contact.contact_first_name' },
{ data: 'contact.contact_last_name', name: 'contact.contact_last_name' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CompanyRole').DataTable(dtOverrideGlobals);
