...
@can('material_finish_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.material-finishes.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-MaterialFinish">
            <thead>
                <tr>
                    <th width="10">
...
@can('material_finish_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.material-finishes.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.material-finishes.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-MaterialFinish').DataTable(dtOverrideGlobals);
