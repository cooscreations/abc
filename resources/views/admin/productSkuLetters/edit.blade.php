...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-sku-letters.update", [$productSkuLetter->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="letter_code">{{ trans('cruds.productSkuLetter.fields.letter_code') }}</label>
                <input class="form-control {{ $errors->has('letter_code') ? 'is-invalid' : '' }}" type="text" name="letter_code" id="letter_code" value="{{ old('letter_code', $productSkuLetter->letter_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $productSkuLetter->full_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $productSkuLetter->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sharepoint_url') ? 'is-invalid' : '' }}" type="text" name="sharepoint_url" id="sharepoint_url" value="{{ old('sharepoint_url', $productSkuLetter->sharepoint_url) }}">
