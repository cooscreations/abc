...
{ data: 'alpha_2', name: 'alpha_2' },
{ data: 'world_region_name', name: 'world_region.name' },
{ data: 'default_currency_name', name: 'default_currency.name' },
{ data: 'default_currency.alpha_3', name: 'default_currency.alpha_3' },
{ data: 'iso_number', name: 'iso_number' },
