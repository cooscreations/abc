    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nda_sign_date') ? 'is-invalid' : '' }}" type="text" name="nda_sign_date" id="nda_sign_date" value="{{ old('nda_sign_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('honesty_sign_date') ? 'is-invalid' : '' }}" type="text" name="honesty_sign_date" id="honesty_sign_date" value="{{ old('honesty_sign_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('public_bio') ? 'is-invalid' : '' }}" name="public_bio" id="public_bio">{{ old('public_bio') }}</textarea>
