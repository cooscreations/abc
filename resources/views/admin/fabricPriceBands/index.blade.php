...
@can('fabric_price_band_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.fabric-price-bands.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-FabricPriceBand">
            <thead>
                <tr>
                    <th width="10">
...
@can('fabric_price_band_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fabric-price-bands.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fabric-price-bands.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'band_letter', name: 'band_letter' },
{ data: 'cny_start_price', name: 'cny_start_price' },
{ data: 'cny_finish_price', name: 'cny_finish_price' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-FabricPriceBand').DataTable(dtOverrideGlobals);
