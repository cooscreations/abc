...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fabric-price-bands.update", [$fabricPriceBand->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.fabricPriceBand.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $fabricPriceBand->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('band_letter') ? 'is-invalid' : '' }}" type="text" name="band_letter" id="band_letter" value="{{ old('band_letter', $fabricPriceBand->band_letter) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $fabricPriceBand->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cny_start_price') ? 'is-invalid' : '' }}" type="number" name="cny_start_price" id="cny_start_price" value="{{ old('cny_start_price', $fabricPriceBand->cny_start_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cny_finish_price') ? 'is-invalid' : '' }}" type="number" name="cny_finish_price" id="cny_finish_price" value="{{ old('cny_finish_price', $fabricPriceBand->cny_finish_price) }}" step="0.01" required>
