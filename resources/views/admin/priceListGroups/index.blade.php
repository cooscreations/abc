...
@can('price_list_group_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.price-list-groups.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PriceListGroup">
            <thead>
                <tr>
                    <th width="10">
...
@can('price_list_group_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.price-list-groups.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.price-list-groups.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-PriceListGroup').DataTable(dtOverrideGlobals);
