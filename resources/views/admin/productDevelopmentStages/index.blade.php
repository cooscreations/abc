...
@can('product_development_stage_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.product-development-stages.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ProductDevelopmentStage">
            <thead>
                <tr>
                    <th width="10">
...
@can('product_development_stage_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.product-development-stages.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.product-development-stages.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ProductDevelopmentStage').DataTable(dtOverrideGlobals);
