    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-companies.update", [$contactCompany->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_short_code') ? 'is-invalid' : '' }}" type="text" name="company_short_code" id="company_short_code" value="{{ old('company_short_code', $contactCompany->company_short_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('formal_reg_name') ? 'is-invalid' : '' }}" type="text" name="formal_reg_name" id="formal_reg_name" value="{{ old('formal_reg_name', $contactCompany->formal_reg_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('local_name') ? 'is-invalid' : '' }}" type="text" name="local_name" id="local_name" value="{{ old('local_name', $contactCompany->local_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('company_reg_date') ? 'is-invalid' : '' }}" type="text" name="company_reg_date" id="company_reg_date" value="{{ old('company_reg_date', $contactCompany->company_reg_date) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_english_speaking_staff') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="has_english_speaking_staff" id="has_english_speaking_staff" value="1" {{ $contactCompany->has_english_speaking_staff || old('has_english_speaking_staff', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_reg_num') ? 'is-invalid' : '' }}" type="text" name="company_reg_num" id="company_reg_num" value="{{ old('company_reg_num', $contactCompany->company_reg_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('company_reg_expiry') ? 'is-invalid' : '' }}" type="text" name="company_reg_expiry" id="company_reg_expiry" value="{{ old('company_reg_expiry', $contactCompany->company_reg_expiry) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('export_license_num') ? 'is-invalid' : '' }}" type="text" name="export_license_num" id="export_license_num" value="{{ old('export_license_num', $contactCompany->export_license_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('import_license_num') ? 'is-invalid' : '' }}" type="text" name="import_license_num" id="import_license_num" value="{{ old('import_license_num', $contactCompany->import_license_num) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('social_9001') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="social_9001" id="social_9001" value="1" {{ $contactCompany->social_9001 || old('social_9001', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('production_9001') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="production_9001" id="production_9001" value="1" {{ $contactCompany->production_9001 || old('production_9001', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('anti_slavery_policy') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="anti_slavery_policy" id="anti_slavery_policy" value="1" {{ $contactCompany->anti_slavery_policy || old('anti_slavery_policy', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('bsci_certified') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="bsci_certified" id="bsci_certified" value="1" {{ $contactCompany->bsci_certified || old('bsci_certified', 0) === 1 ? 'checked' : '' }}>
