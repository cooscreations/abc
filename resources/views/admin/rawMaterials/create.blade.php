        ...
        <form method="POST" action="{{ route("admin.raw-materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_vegan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_vegan" id="is_vegan" value="1" {{ old('is_vegan', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_sustainable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_sustainable" id="is_sustainable" value="1" {{ old('is_sustainable', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_ukfr_std') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_ukfr_std" id="is_ukfr_std" value="1" {{ old('is_ukfr_std', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_ukfr_treatable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_ukfr_treatable" id="is_ukfr_treatable" value="1" {{ old('is_ukfr_treatable', 0) == 1 ? 'checked' : '' }}>
