...
class DocumentsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.documents.index', compact('documents', 'orders', 'products', 'product_skus', 'users', 'contact_companies', 'contact_contacts', 'document_types', 'file_types', 'user_types'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.documents.create', compact('related_orders', 'related_products', 'related_skus', 'related_users', 'related_companies', 'related_contacts', 'document_types', 'file_types', 'authorised_user_types'));
    }
    ...
    public function edit(Document $document)
    {
        ...
        return view('frontend.documents.edit', compact('related_orders', 'related_products', 'related_skus', 'related_users', 'related_companies', 'related_contacts', 'document_types', 'file_types', 'authorised_user_types', 'document'));
    }
