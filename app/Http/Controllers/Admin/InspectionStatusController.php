...
class InspectionStatusController extends Controller
{
    public function index()
    {
        ...
        return view('admin.inspectionStatuses.index', compact('inspectionStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.inspectionStatuses.create');
    }
    ...
    public function store(StoreInspectionStatusRequest $request)
    {
        ...
        return redirect()->route('admin.inspection-statuses.index');
    }
    ...
    public function edit(InspectionStatus $inspectionStatus)
    {
        ...
        return view('admin.inspectionStatuses.edit', compact('inspectionStatus'));
    }
    ...
    public function show(InspectionStatus $inspectionStatus)
    {
        ...
        return view('admin.inspectionStatuses.show', compact('inspectionStatus'));
    }
