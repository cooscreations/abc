...
class AddressesApiController extends Controller
{
    public function index()
    {
        ...
        return new AddressResource(Address::with(['company', 'province', 'country', 'nearest_shipping_port'])->get());
    }
    ...
    public function show(Address $address)
    {
        ...
        return new AddressResource($address->load(['company', 'province', 'country', 'nearest_shipping_port']));
    }
