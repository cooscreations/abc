...
class ContactCompanyApiController extends Controller
{
    public function index()
    {
        ...
        return new ContactCompanyResource(ContactCompany::with(['parent_company', 'primary_company_type', 'reg_country', 'owner_contact', 'ownership_type', 'primary_language', 'addresses'])->get());
    }
    ...
    public function show(ContactCompany $contactCompany)
    {
        ...
        return new ContactCompanyResource($contactCompany->load(['parent_company', 'primary_company_type', 'reg_country', 'owner_contact', 'ownership_type', 'primary_language', 'addresses']));
    }
