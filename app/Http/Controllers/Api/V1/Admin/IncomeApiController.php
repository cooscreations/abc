...
class IncomeApiController extends Controller
{
    public function index()
    {
        ...
        return new IncomeResource(Income::with(['income_category', 'bank_account', 'exchange_rate', 'currency', 'order'])->get());
    }
    ...
    public function show(Income $income)
    {
        ...
        return new IncomeResource($income->load(['income_category', 'bank_account', 'exchange_rate', 'currency', 'order']));
    }
